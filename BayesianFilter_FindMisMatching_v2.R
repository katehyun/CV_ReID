...
for (i in 1: length(Upsiglist_test)) {  
  for (j in 1: length(Upcandidatesindex_test[[i]])) {  
    ...
    Attribute_diff_test_mat[[i]][[j]][31] <- a_magdif_test[[i]][[j]] 
    Attribute_diff_test_nonmat[[i]][[j]][31] <- a_magdif_test[[i]][[j]] 
...
# for (i in 1:3){
  ...
  if ( as.numeric ( Downtarget_attributes_train [i,2] ) == 9 ) {  # Only Class 9
   ...
   if ( is.na ( Attribute_diff_nonnormal_train[[i]][1])   ) {
     idxjointprob_train[k] <- 999
     UpFinalcandidates_train[k] <- 999
   }
      ...
      for (j in 1: length(  Upcandidatesindex_train[[i]]  )  ) {
          ...
          jointprobtemp_train [is.na(jointprobtemp_train )] <- buf 
           ...
           jointprobtemp_train[j,32] <-  jointprobtemp_train[j,1] * jointprobtemp_train[j,2] * jointprobtemp_train[j,3]  * 
              jointprobtemp_train[j,4] * jointprobtemp_train[j,6] * jointprobtemp_train[j,7] * 
              jointprobtemp_train[j,13] * jointprobtemp_train[j,14] *  jointprobtemp_train[j,15] * jointprobtemp_train[j,16] *
              jointprobtemp_train[j,17] * jointprobtemp_train[j,18] *  jointprobtemp_train[j,19] *  jointprobtemp_train[j,20] *
              jointprobtemp_train[j,21] * jointprobtemp_train[j,30]  *
    ...
    if ( is.na ( Attribute_diff_nonnormal_test[[i]][1])   ) {
      ...
      for (j in 1: length(  Upcandidatesindex_test[[i]]  )  ) {
        ...
        jointprobtemp_test[j,32] <-  jointprobtemp_test[j,1] * jointprobtemp_test[j,2] * jointprobtemp_test[j,3] *  
          jointprobtemp_test[j,4]  * jointprobtemp_test[j,6] * jointprobtemp_test[j,7] *  
          jointprobtemp_test[j,13] * jointprobtemp_test[j,14] *  jointprobtemp_test[j,15] * jointprobtemp_test[j,16] *
          jointprobtemp_test[j,17] * jointprobtemp_test[j,18] *  jointprobtemp_test[j,19] *  jointprobtemp_test[j,20] *
          jointprobtemp_test[j,21] *   jointprobtemp_test[j,30]  *
